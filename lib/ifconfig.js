...
/**
 * Parse ifconfig for interfaces
 * @param  Function callback function called with the result of ifconfig stdout
 * @return String   output from ifconfig
 */
...
/**
 * Process the ifconfig from string data to interface objects
 * @param  Object   error error from child_process.exec
 * @param  String   stdout output from child_process.exec
 * @param  String   stderr error output from child_process.exec
 * @param  Function cb callback function called with the return result.
 * @return Array    List of interface objects found in ifconfig
 */
